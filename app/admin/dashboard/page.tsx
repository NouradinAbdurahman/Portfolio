  ...
  if (!userEmail) {
    return (
      <div className="min-h-screen flex items-center justify-center site-background px-4">
        <div className="max-w-md w-full text-center backdrop-blur-xl bg-white/80 dark:bg-black/20 border border-gray-200 dark:border-white/10 rounded-2xl p-8">
          <h1 className="text-2xl font-semibold mb-2 dark:text-white text-gray-900">Access denied</h1>
          <p className="mb-6 text-gray-700 dark:text-white/60">You must be signed in.</p>
  ...
  if (!authorized) {
    return (
      <div className="min-h-screen flex items-center justify-center site-background px-4">
        <div className="max-w-md w-full text-center backdrop-blur-xl bg-white/80 dark:bg-black/20 border border-gray-200 dark:border-white/10 rounded-2xl p-8">
          <h1 className="text-2xl font-semibold mb-2 dark:text-white text-gray-900">Access denied</h1>
          <p className="text-gray-700 dark:text-white/70">Your account is not authorized to access this dashboard.</p>
        </div>
      </div>
    )
  }
    ...
    <div className="min-h-screen flex items-center justify-center site-background px-4 relative overflow-hidden">
      ...
      <div className="w-full max-w-xl">
        <div className="relative rounded-3xl p-[1px] bg-gradient-to-b from-[var(--primary)]/40 via-transparent to-transparent">
          <div className="rounded-3xl p-6 sm:p-8 backdrop-blur-xl bg-white/80 dark:bg-black/20 border border-gray-200 dark:border-white/10 shadow-2xl">
            <div className="mb-6 sm:mb-8">
              <h1 className="text-2xl sm:text-3xl font-bold tracking-tight dark:text-white text-gray-900">
                Welcome,
                <br className="hidden sm:block" /> {userEmail}
              </h1>
              <p className="mt-2 text-sm sm:text-base text-gray-700 dark:text-white/60">You are now in the Admin Dashboard.</p>
            </div>
